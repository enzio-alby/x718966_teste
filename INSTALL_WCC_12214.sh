...
# ── Gravar domain ──
# setOpssWalletPassPhrase inicializa o Shared Secret Store (CSF)
# obrigatorio antes de updateDomain quando OPSS usa persistencia em banco
print('Configurando OPSS wallet passphrase...')
setOpssWalletPassPhrase(ADMIN_PASS)
print('OPSS wallet passphrase configurado.')
