...
def createDomain():
    ...
    selectCustomTemplate(ORACLE_HOME + '/common/templates/wls/oracle.ucm.cs_template.jar')
    selectCustomTemplate(ORACLE_HOME + '/common/templates/wls/oracle.ucm.ibr_template.jar')
    selectCustomTemplate(ORACLE_HOME + '/common/templates/wls/oracle.ipm_template.jar')
    selectCustomTemplate(ORACLE_HOME + '/common/templates/wls/oracle.wcc.adf.rui_template.jar')
    loadTemplates()
