...
def createDomain():
    ...
    selectCustomTemplate(ORACLE_HOME + '/wccontent/common/templates/wls/oracle.ucm.cs_template.jar')
    selectCustomTemplate(ORACLE_HOME + '/wccontent/common/templates/wls/oracle.ucm.ibr_template.jar')
    selectCustomTemplate(ORACLE_HOME + '/wccontent/common/templates/wls/oracle.ipm_template.jar')
    selectCustomTemplate(ORACLE_HOME + '/wccontent/common/templates/wls/oracle.wcc.adf.rui_template.jar')
    loadTemplates()
    ...
    # ── JRF bootstrap: substitui placeholders OPSS/MDS do template ──
    print('Inicializando JRF database defaults (OPSS bootstrap)...')
    cd('/')
    try:
        getDatabaseDefaults()
        print('JRF bootstrap concluido.')
    except Exception, e:
        print('AVISO getDatabaseDefaults: ' + str(e)[:120])
